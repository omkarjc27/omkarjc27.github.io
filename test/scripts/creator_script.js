...
function InitialRender() {
	...
	for (var i = 0; i < data['tale'].length; i++){
		...
		switch(data['tale'][i]['type']){
			case null:
				space += '<span class="file-upload-label" onclick="UpdateMedia('+data['tale'][i]['id']+',0)"><i class="fa fa-font w3-medium"></i><br>Text </span><label class="file-upload-label" for="'+data['tale'][i]['id']+'_0" ><i class="fa fa-image w3-medium"></i><br>Image</label><input id="'+data['tale'][i]['id']+'_0" class="file-upload-input" type="file" onchange="UpdateMedia('+data['tale'][i]['id']+',1)" accept="image/*"><label for="'+data['tale'][i]['id']+'_1" class="file-upload-label"><i class="fa fa-film w3-medium"></i><br>Video</label><input id="'+data['tale'][i]['id']+'_1" class="file-upload-input" type="file" onchange="UpdateMedia('+data['tale'][i]['id']+',2)" accept="video/*">'
				break;
			case 0:
...
function AddPage(id){
	...
	new_page +='<span class="file-upload-label" onclick="UpdateMedia('+counter+',0)"><i class="fa fa-font w3-medium"></i><br>Text </span><label class="file-upload-label" for="'+counter+'_0" ><i class="fa fa-image w3-medium"></i><br>Image</label><input id="'+counter+'_0" class="file-upload-input" type="file" onchange="UpdateMedia('+counter+',1)" accept="image/*"><label for="'+counter+'_1" class="file-upload-label"><i class="fa fa-film w3-medium"></i><br>Video</label><input id="'+counter+'_1" class="file-upload-input" type="file" onchange="UpdateMedia('+counter+',2)" accept="video/*">'
